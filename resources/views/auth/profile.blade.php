...
<div class="px-10 bg-custom-400 py-8">
    <div class="mb-10">
        <div class="flex justify-start items-center mb-4">
            <a href="{{ route("landing") }}" onclick="window.history.back();" class="text-lg font-semibold flex items-center py-3 px-2 rounded-xl text-gray-700 bg-gray-200 shadow border-gray-100">
    ...
    <div class="flex justify-center pb-4">
        ...
        <div class="grid space-y-4 w-full">
            <div class="rounded-xl border-custom-200 w-4/5">
                <div class="flex gap-4">
                    ...
                    <div class="flex justify-between bg-custom-50 rounded-xl p-4">
            ...
            <div class="bg-custom-50 rounded-md p-4 border border-custom-50">
                ...
                <div class="mt-6">
                    <!-- Edit Profil -->
                    <div class="flex justify-between items-center rounded-xl bg-custom-75 hover:bg-custom-100 hover:rounded p-4">
