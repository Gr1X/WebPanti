    ...
    <div class="flex justify-between items-center bg-slate-800">
        ...
        <ul class="flex mx-4">
            ...
            <li class="text-center group relative flex-shrink-0 px-2 py-2 my-2 hover:scale-105 duration-300">
                ...
                <a href="{{route('landing')}}" class="inline-block flex flex-col items-center group-hover:bg-slate-400 px-6 py-0.5 rounded-xl group-hover:shadow-xl text-slate-100 active:scale-95 duration-300">
            ...
            <li class="text-center group relative flex-shrink-0 px-2 py-2 my-2 hover:scale-105 duration-300">
                <span class="absolute inset-x-0 top-0 h-0.5 group-hover:bg-indigo-600 w-8 left-1/2 transform -translate-x-1/2"></span>
                <a href="{{route('donation')}}" class="inline-block flex flex-col items-center group-hover:bg-slate-400 px-6 py-0.5 rounded-xl group-hover:shadow-xl text-slate-100 active:scale-95 duration-300">
            ...
            <li class="text-center group relative flex-shrink-0 px-2 py-2 my-2 hover:scale-105 duration-300">
                <span class="absolute inset-x-0 top-0 h-0.5 group-hover:bg-indigo-600 w-8 left-1/2 transform -translate-x-1/2"></span>
                <a href="{{route('gallery')}}" class="inline-block flex flex-col items-center group-hover:bg-slate-400 px-6 py-0.5 rounded-xl group-hover:shadow-xl text-slate-100 active:scale-95 duration-300">
            ...
            <li class="text-center group relative flex-shrink-0 px-2 py-2 my-2 hover:scale-105 duration-300">
                <span class="absolute inset-x-0 top-0 h-0.5 group-hover:bg-indigo-600 w-8 left-1/2 transform -translate-x-1/2"></span>
                <a href="{{route('program')}}" class="inline-block flex flex-col items-center group-hover:bg-slate-400 px-6 py-0.5 rounded-xl group-hover:shadow-xl text-slate-100 active:scale-95 duration-300">
