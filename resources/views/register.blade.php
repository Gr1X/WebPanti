            ...
            <div class="">
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="mt-6">
                    ...
                    <div class="grid gap-2 mb-4">
                        ...
                        <div class="flex gap-2">
                            <div class="flex items-center bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-0.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <input type="text" name="name" id="name" class="w-full text-sm bg-transparent border-transparent" placeholder="Full Name" value="{{ old('name') }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-2 mb-4">
                        ...
                        <div class="flex items-center bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-0.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <input type="email" name="email" id="email" class="w-full text-sm bg-transparent border-transparent" placeholder="Input Email" value="{{ old('email') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-2 mb-4">
                        ...
                        <div class="flex items-center bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-0.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <input type="text" name="no_telp" id="no_telp" class="w-full text-sm bg-transparent border-transparent" placeholder="Input Phone Number" value="{{ old('no_telp') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-2 mb-4">
                        ...
                        <div class="flex items-center bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-0.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <input type="password" name="password" id="password" class="w-full text-sm bg-transparent border-transparent" placeholder="Input Password" required>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-2 mb-4">
                        ...
                        <div class="flex items-center bg-gray-50 border border-gray-300 text-gray-900 rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-0.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <input type="password" name="password_confirmation" id="password_confirmation" class="w-full text-sm bg-transparent border-transparent" placeholder="Confirm Password" required>
                        </div>
                    </div>
