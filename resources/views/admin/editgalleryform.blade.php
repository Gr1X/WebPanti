                                ...
                                <div id="upload-prompt" class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label for="gambar" class="relative cursor-pointer rounded-md font-medium text-blue-600">
                                            ...
                                            <input id="gambar" name="gambar" type="file" class="sr-only" accept="image/jpeg, image/jpg, image/gif" onchange="handleFileUpload(event)" />
                                        </label>
                                        <p class="pl-1">or drag and drop</p>
                                    </div>
                                    <p class="text-xs text-gray-500">PNG, JPG, GIF up to 10MB</p>
                                </div>
                                <div id="preview" class="absolute inset-0 flex items-center justify-center hidden" onclick="triggerFileInput()">
                                    <img src="{{ asset('storage/' . $gallery->gambar) }}" alt="Current image" class="w-full h-full object-cover rounded-md" />
                                </div>
                            </div>
                        </div>
