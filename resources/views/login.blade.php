        ...
        <div class="">
            ...
            <form action="{{ route('login.submit') }}" method="POST" class="mt-6">
                ...
                <div class="grid gap-2 mb-4">
                    ...
                    <div class="flex items-center bg-gray-50 border border-gray-300 text-gray-900 rounded block w-full p-0.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        <input type="password" id="password" name="password" class="w-full text-sm bg-transparent border-transparent" placeholder="Input your password" required>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="#" class="text-sm text-sky-500">Forgot Password?</a>
                </div>
